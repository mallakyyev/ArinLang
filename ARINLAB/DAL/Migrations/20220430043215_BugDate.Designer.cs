...
namespace DAL.Migrations
{
    ...
    [Migration("20220430043215_BugDate")]
    partial class BugDate
    {
            ...
            modelBuilder.Entity("DAL.Models.Names", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        ...
                        .HasDefaultValue(new DateTime(2022, 4, 30, 9, 32, 14, 611, DateTimeKind.Local).AddTicks(7390));
            ...
            modelBuilder.Entity("DAL.Models.Word", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 30, 9, 32, 14, 595, DateTimeKind.Local).AddTicks(9316));
            ...
            modelBuilder.Entity("DAL.Models.WordClause", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 30, 9, 32, 14, 587, DateTimeKind.Local).AddTicks(4661));
            ...
            modelBuilder.Entity("DAL.Models.WordSentences", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 4, 30, 9, 32, 14, 598, DateTimeKind.Local).AddTicks(6883));
