...
namespace DAL.Migrations
{
    ...
    [Migration("20220501184915_Dictionary_isActiveAddded")]
    partial class Dictionary_isActiveAddded
    {
            ...
            modelBuilder.Entity("DAL.Models.Bag", b =>
                {
                    ...
                    b.Property<DateTime>("Date")
                        ...
                        .HasDefaultValue(new DateTime(2022, 5, 1, 23, 49, 14, 773, DateTimeKind.Local).AddTicks(5376));
            ...
            modelBuilder.Entity("DAL.Models.Names", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 23, 49, 14, 799, DateTimeKind.Local).AddTicks(5761));
            ...
            modelBuilder.Entity("DAL.Models.Word", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 23, 49, 14, 787, DateTimeKind.Local).AddTicks(7083));
            ...
            modelBuilder.Entity("DAL.Models.WordClause", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 23, 49, 14, 784, DateTimeKind.Local).AddTicks(7635));
            ...
            modelBuilder.Entity("DAL.Models.WordSentences", b =>
                {
                    ...
                    b.Property<DateTime>("AddedDate")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("datetime2")
                        .HasDefaultValue(new DateTime(2022, 5, 1, 23, 49, 14, 789, DateTimeKind.Local).AddTicks(6318));
